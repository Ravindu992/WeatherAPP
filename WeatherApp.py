...
def getWeather():
    ...
    try:
        ...
        geolocator = Nominatim(user_agent="weather_app/1.0 (rdevinda944@gmail.com)")
        ...
        api_key = "3838fd0a516ae3bd4e7fd41e359fd21d"
        ...
        if json_data.get("cod") != 200:
            messagebox.showerror("Error", json_data.get("message", "Unknown error"))
            return
